...
class Ui_RomAssessWindow(object):
    def setupUi(self, RomAssessWindow):
        ...
        RomAssessWindow.resize(751, 319)
        self.centralwidget = QtWidgets.QWidget(RomAssessWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 731, 281))
        ...
        self.lblInstruction.setStyleSheet("color: rgb(0, 0, 127);")
    ...
    def retranslateUi(self, RomAssessWindow):
        ...
        self.lblInstruction.setText(_translate("RomAssessWindow", "TextLabel"))
