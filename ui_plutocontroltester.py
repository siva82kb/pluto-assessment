...
class Ui_PlutoControlTesterWindow(object):
    def setupUi(self, PlutoControlTesterWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 431, 397))
        ...
        self.radioObjectSim = QtWidgets.QRadioButton(self.gbControlType)
        self.radioObjectSim.setObjectName("radioObjectSim")
        ...
        self.lblObjectStiffness = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lblObjectStiffness.setMinimumSize(QtCore.QSize(320, 20))
        self.lblObjectStiffness.setMaximumSize(QtCore.QSize(320, 20))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Light")
        font.setPointSize(12)
        self.lblObjectStiffness.setFont(font)
        self.lblObjectStiffness.setStyleSheet("color: rgb(170, 0, 0);")
        self.lblObjectStiffness.setObjectName("lblObjectStiffness")
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.lblObjectStiffness)
        ...
        self.dsbObjPos.setMinimum(1.0)
        self.dsbObjPos.setMaximum(10.0)
        self.dsbObjPos.setSingleStep(0.01)
        self.dsbObjPos.setObjectName("dsbObjPos")
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.dsbObjPos)
        self.dsbObjStiff = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Cascadia Mono Light")
        font.setPointSize(10)
        self.dsbObjStiff.setFont(font)
        self.dsbObjStiff.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.dsbObjStiff.setDecimals(2)
        self.dsbObjStiff.setMinimum(1.0)
        self.dsbObjStiff.setMaximum(10.0)
        self.dsbObjStiff.setSingleStep(0.01)
        self.dsbObjStiff.setObjectName("dsbObjStiff")
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.dsbObjStiff)
    ...
    def retranslateUi(self, PlutoControlTesterWindow):
        ...
        self.lblObjectStiffness.setText(_translate("PlutoControlTesterWindow", "Object Stiffness:"))
